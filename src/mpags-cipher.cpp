...
int main(int argc, char* argv[])
{
 ...
 CaesarCipher caesar_key {settings.cipher_key}; //checks are done in the class
  

  // Run the Caesar cipher (using the specified key and encrypt/decrypt flag) on the input text
  std::string outputText { runCaesarCipher( inputText,caesar_key.key , settings.encrypt ) };
